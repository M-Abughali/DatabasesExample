...
import com.ghalym.databasesexample.roomExample.Note.displayNote.NoteAdapter
import com.ghalym.databasesexample.roomExample.Note.updateNote.UpdateNoteActivity
...
class DisplayNotesActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.lbl_displayNotesActivity_title_Room)
